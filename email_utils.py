...
async def send_password_reset_email(to_email: str, username: str, token: str) -> None:
    ...
    template = templates.env.get_template("email/password_reset.html") # template_response - needs a request object but for emails, we don't have a response. We just want the rendered string.
